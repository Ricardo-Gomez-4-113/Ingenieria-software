...
<html>
	<head>
		...
		<link rel="Login" href="Login\index.html" />
		<button type="button" class="btn btn-primary">Datos de contacto</button>
		<button type="button" class="btn btn-primary">Chat</button>
		<button type="button" class="btn btn-primary">Valoracion</button>
						...
						<!-- Items -->
							<div class="items">
								...
								<article class="item thumb span-1">
									<h2>Mueble 1</h2>
									<a href="<?php echo base_url("images/fulls/01.jpg");?>" class="image"><img src="<?php echo base_url("images/thumbs/01.jpg");?>" alt=""></a>
								</article>

								<article class="item thumb span-2">
									<h2>Mueble 2</h2>
									<a href="<?php echo base_url("images/fulls/02.jpg");?>" class="image"><img src="<?php echo base_url("images/thumbs/02.jpg");?>" alt=""></a>
								</article>

								<article class="item thumb span-1">
									<h2>Mueble 3</h2>
									<a href="<?php echo base_url("images/fulls/03.jpg");?>" class="image"><img src="<?php echo base_url("images/thumbs/03.jpg");?>" alt=""></a>
								</article>

								<article class="item thumb span-1">
									<h2>Mueble 4</h2>
									<a href="<?php echo base_url("images/fulls/04.jpg");?>" class="image"><img src="<?php echo base_url("images/thumbs/04.jpg");?>" alt=""></a>
								</article>

								<article class="item thumb span-3">
									<h2>Mueble 5</h2>
									<a href="<?php echo base_url("images/fulls/05.jpg");?>" class="image"><img src="<?php echo base_url("images/thumbs/05.jpg");?>" alt=""></a>
								</article>

								<article class="item thumb span-1">
									<h2>Mueble 6</h2>
									<a href="<?php echo base_url("images/fulls/06.jpg");?>" class="image"><img src="<?php echo base_url("images/thumbs/06.jpg");?>" alt=""></a>
								</article>

								<article class="item thumb span-2">
									<h2>Mueble 7</h2>
									<a href="<?php echo base_url("images/thumbs/06.jpg");?>");?>" class="image"><img src="<?php echo base_url("images/thumbs/07.jpg");?>" alt=""></a>
								</article>

								<article class="item thumb span-2">
									<h2>Mueble 8</h2>
									<a href="<?php echo base_url("images/thumbs/08.jpg");?>" class="image"><img src="<?php echo base_url("images/thumbs/08.jpg");?>" alt=""></a>
								</article>
				...
				<!-- Footer -->
					<section id="footer">
						...
						<section>
							...
							<ul class="copyright">
								<li>&copy; Untitled</li><li>Design: <a href="http://html5up.net">Ricardo Gomez</a></li>
							</ul>
						</section>
					</section>
